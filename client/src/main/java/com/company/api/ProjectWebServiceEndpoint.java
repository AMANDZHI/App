...
public interface ProjectWebServiceEndpoint {
    ...
    public com.company.api.ProjectDTO saveProject(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public com.company.api.ProjectDTO updateProject(
        @WebParam(name = "name", targetNamespace = "")
        java.lang.String name,
    ...
    @WebResult(name = "return", targetNamespace = "")
    public java.util.List<com.company.api.ProjectDTO> getListProject(
        @WebParam(name = "session", targetNamespace = "")
        com.company.api.Session session
    );
    ...
    @WebResult(name = "return", targetNamespace = "")
    public com.company.api.ProjectDTO findByIdProject(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public com.company.api.ProjectDTO findByNameProject(
        @WebParam(name = "project_name", targetNamespace = "")
        java.lang.String projectName,
        @WebParam(name = "session", targetNamespace = "")
        com.company.api.Session session
