 ...
 * 2019-02-15T19:12:17.598+03:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "SessionWebServiceEndpointImplService",
                  wsdlLocation = "http://localhost:1986/wss/session?wsdl",
...
public class SessionWebServiceEndpointImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:1986/wss/session?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SessionWebServiceEndpointImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:1986/wss/session?wsdl");
        }
        WSDL_LOCATION = url;
    }
