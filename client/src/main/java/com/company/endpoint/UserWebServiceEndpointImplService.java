...
@WebServiceClient(name = "UserWebServiceEndpointImplService",
                  wsdlLocation = "http://localhost:1986/wss/user?wsdl",
...
public class UserWebServiceEndpointImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:1986/wss/user?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserWebServiceEndpointImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:1986/wss/user?wsdl");
        }
        WSDL_LOCATION = url;
    }
